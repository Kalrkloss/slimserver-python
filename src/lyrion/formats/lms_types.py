...
TYPES_CONF: dict[str, tuple[tuple[str, ...], tuple[str, ...]]] = {
    # Verbatim aus /tmp/lms-ref/types.conf (Spalten: Typ Suffixe MIME-Typen);
    # "-" bedeutet "keine". Die Tabelle ist DATEN, keine Ableitung — sie
    # enthält auch Nicht-Audio-Typen (Bilder/Playlists), weil Perl sie beim
    # Content-Type-/Endungs-Lookup genauso kennt (nur 15 von 65 Typen zu
    # führen ließ z. B. .m3u/.pls/.asx/.ape/.wv unbekannt).
    "aif": (("aif", "aiff"),
           ("audio/x-aiff",)),
    "alc": ((),
    ...
    "asx": (("asx", "wax"),
           ("video/asx", "application/asx", "application/vnd.ms-asf", "video/x-ms-asf", "audio/x-ms-wax", "audio/x-ms-asf", "video/x-ms-wvx")),
    "css": (("css",),
           ("text/css",)),
    "cue": (("cue",),
           ("audio/x-cue",)),
    "cur": ((),
           ("audio/x-cue-referenced",)),
    "dff": (("dff",),
           ("audio/dff",)),
    "dir": ((),
    ...
    "log": (("log",),
           ("text/plain",)),
    "lpcm": (("lpcm", "l16", "l24"),
           ("audio/L16", "audio/L24", "audio/x-pcm")),
    "ico": (("ico",),
           ("image/x-icon",)),
    "jpg": (("jpg", "jpeg"),
           ("image/jpeg",)),
    ...
    "mpc": (("mpc", "mp+"),
           ("audio/x-musepack",)),
    "ogg": (("ogg", "oga"),
           ("audio/x-ogg", "application/ogg", "audio/ogg", "application/x-ogg")),
    "ogf": (("ogf",),
    ...
    "wma": (("wma",),
           ("audio/x-ms-wma", "application/vnd.ms.wms-hdr.asfv1", "application/x-mms-framed", "audio/asf")),
    "wmal": ((),
           ("audio/x-wma-lossless",)),
    "wmap": ((),
           ("audio/x-wma-wmapro",)),
    "wpl": (("wpl",),
    ...
    "zip": (("zip",),
           ("application/zip",)),
    "src": ((),
           ("audio/x-digital-input",)),
    "spdr": ((),
           ("audio/x-squeezeplaydirect",)),
    "itu": (("itunesplaylist:",),
           ("audio/x-itunesplaylist",)),
    "mmp": (("musicipplaylist:",),
           ("audio/x-musicipplaylist",)),
    "mood": ((),
           ("audio/x-musicipmood",)),
    "ssp": (("playlist:",),
           ("audio/x-slimserverplaylist",)),
    "cpl": (("clientplaylist:",),
           ("audio/x-slimserverplaylist",)),
    "rnd": ((),
           ("audio/x-randomplay",)),
